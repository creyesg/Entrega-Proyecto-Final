...
Public Class empleadosInternos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Control_EntregasWeb.empleadosInternos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedempleadosInternos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As empleadosInternos = New empleadosInternos()
        rpt.Site = Me.Site
        Return rpt
    End Function
