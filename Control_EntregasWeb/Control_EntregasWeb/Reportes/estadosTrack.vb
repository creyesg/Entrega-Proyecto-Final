...
Public Class estadosTrack
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Control_EntregasWeb.estadosTrack.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedestadosTrack
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As estadosTrack = New estadosTrack()
        rpt.Site = Me.Site
        Return rpt
    End Function
