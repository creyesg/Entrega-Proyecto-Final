...
Public Class paqEntregados
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Control_EntregasWeb.paqEntregados.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedpaqEntregados
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As paqEntregados = New paqEntregados()
        rpt.Site = Me.Site
        Return rpt
    End Function
