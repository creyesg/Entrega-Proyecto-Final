...
Public Class empleadosOdenes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Control_EntregasWeb.empleadosOdenes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedempleadosOdenes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As empleadosOdenes = New empleadosOdenes()
        rpt.Site = Me.Site
        Return rpt
    End Function
