...
Public Class empresasOdenes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Control_EntregasWeb.empresasOdenes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedempresasOdenes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As empresasOdenes = New empresasOdenes()
        rpt.Site = Me.Site
        Return rpt
    End Function
