...
Public Class segTracking
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Control_EntregasWeb.segTracking.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedsegTracking
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As segTracking = New segTracking()
        rpt.Site = Me.Site
        Return rpt
    End Function
