...
Public Class paqCancelados
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Control_EntregasWeb.paqCancelados.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedpaqCancelados
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As paqCancelados = New paqCancelados()
        rpt.Site = Me.Site
        Return rpt
    End Function
